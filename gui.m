...
handles.MessageLength = 100;            % domylúlna liczba bitÛw
handles.SignalToNoiseRatio = 15;        % domyúlna wartoúÊ SNR
handles.text = 'Przyk≥adowa wiadomoúÊ tekstowa';
...
howManyBits = 10000;       %liczba bitÛw do symulacji BER
...
if(handles.bool == 0)
    ...
    S = handles.text;
    if isempty(S)
        set(handles.text25,'String','WPROWADè TEKST POLE NIE MOØE BY∆ PUSTE!');
    else
...
%------------------------FUNKCJE OBS£UGUJ•CE WYB”R KONSTELACJI-------------------------------------
